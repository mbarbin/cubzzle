            ...
            for z0 = 0 to size.z - 1 do
              ...
              for rotation = 0 to Rotation.cardinality - 1 do
                ...
                | Inserted ->
                    ...
                    then (Graphics.clear_graph (); draw_box box ~shown_pieces);
                    aux return q;
  ...
  With_return.with_return (fun return ->
    while true do
      ...
      then return.return ()
        ...
        match
          Graphics.point_color stat.mouse_x stat.mouse_y |> find_piece_by_color
        with
        | None -> ()
  ...
  Command.make ~summary:"Run the solver."
    (let open Command.Std in
     ...
     try
       ...
       | Some box ->
           Box.print_floors box; Out_channel.flush stdout; interactive_view box
