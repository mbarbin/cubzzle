...
module Stack : sig
  (** The box acts as a stack of pieces. One can push and pop pieces from the
      box. *)
  ...
  (** Attempt to push a piece into the box from a given offset, applying a given
      rotation. If the rotated piece exceeds the box boundary, or cannot fit due
      to another piece, the function returns [Not_available] and [t] is
      unchanged. *)
end
